//Write a C++ program to implement Double Ended Queue Output Restricted from Front
#include<iostream>
using namespace std;
...
int deletefront()
{
	cout<<"Your can't Output/Delete Value from Front....."<<endl;
	return 0;
}
